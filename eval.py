...
if __name__ == '__main__':
    ...
    tt.arg.test_model = 'D-mini_N-5_K-1_U-0_L-3_B-40_T-True_SEED-222' if tt.arg.test_model is None else tt.arg.test_model
    ...
    checkpoint = torch.load('/***/asset/checkpoints/{}/'.format(exp_name) +'checkpoint.pth.tar')
